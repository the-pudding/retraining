...
function setupAnnotations(){
  ...
  const ambulanceAnno = [
	...
	// const powerLineAnno = [
	// 	{note: {title:'Power-line installers',wrap:100,align:"middle",},
	// 		// connector:{end:annoConnector},
	// 				x:electricalPowerLineInstallersAndRepairersCoords.xCoord,y:electricalPowerLineInstallersAndRepairersCoords.yCoord,dx:powerline_AnnotationXBump,dy:powerline_AnnotationYBump,subject: {radius: 10,radiusPadding: 0}
	// 		}
	// 	];
  ...
  const makeSailorsJobAnno = d3.annotation()
	...
	// const makePowerLineJobAnno = d3.annotation()
  // 			.type(d3.annotationCalloutCircle)
  // 			.annotations(powerLineAnno)
  ...
  $chartSvg.append("g")
	...
	// $chartSvg.append("g")
	// 			// .attr("transform",`translate("${0}","${-30}")`)
	// 			.attr("class","anno-group-powerline anno-group")
	// 			.call(makePowerLineJobAnno)
